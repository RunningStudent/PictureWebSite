...
function newMask(isLogin, obj) {
    ...
    function submitLoginDate() {
        ...
        ajax('post', 'http://online.cumt.edu.cn/pictureWebSite/account/Login.ashx', data, function (dataForString) {
            ...
            if (data.isLogined == true) { //登录成功
                ...
                oAVerfiy.innerHTML = '<img src="http://online.cumt.edu.cn/pictureWebSite/handler/ValidateCodeHandler.ashx?' + new Date().getTime() + '" />'; //更新验证码图片
    ...
    function submitRegisterDate() {
        ...
        ajax('post', 'http://online.cumt.edu.cn/pictureWebSite/account/Register.ashx', data, function (dataForString) {
    ...
    function newVerfiy() {
       ...
       oAVerfiy.innerHTML = '<img src="http://online.cumt.edu.cn/pictureWebSite/handler/ValidateCodeHandler.ashx" />'; //验证码图片路径
        ...
        oAVerfiy.onclick = oASpanVerfiy.onclick = function () {
            oAVerfiy.innerHTML = '<img src="http://online.cumt.edu.cn/pictureWebSite/handler/ValidateCodeHandler.ashx?' + new Date().getTime() + '" />';
